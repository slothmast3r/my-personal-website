            ...
            <div className="container">
                <div className="row">
                    <div className="col-lg-8 " data-aos="fade-up">
                        ...
                        <p>
                            <Image src="/assets/images/image_3.jpg" width={500}  height={500} alt="Picture of the author" className="img-fluid"/>
                        </p>
                        ...
                        <p>
                            <Image src="/assets/images/image_4.jpg"  width={500} height={500} alt="Picture of the author" className="img-fluid"/>
                        </p>
