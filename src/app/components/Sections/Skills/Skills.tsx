...
const SkillBar: React.FC<SkillBarProps> = ({ skillName, progressPercent, colorClass }) => {
...
const skillData: SkillBarProps[] = [
    { skillName: "Photoshop", progressPercent: 90, colorClass: "color-1" },
    { skillName: "jQuery", progressPercent: 85, colorClass: "color-2" },
    { skillName: "HTML5", progressPercent: 95, colorClass: "color-3" },
    { skillName: "CSS3", progressPercent: 90, colorClass: "color-4" },
    { skillName: "WordPress", progressPercent: 70, colorClass: "color-5" },
    { skillName: "SEO", progressPercent: 80, colorClass: "color-6" },
];
